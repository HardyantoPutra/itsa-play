...
import com.smuxitsa.MainApplication.service.MembershipService;
...
public class MembershipController {
    ...
    public ResponseEntity<String> retrieveMembers() throws URISyntaxException {
        log.info("Pulling data");
        final String url = "http://localhost:8091/memberships/";
